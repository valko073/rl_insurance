...
class InsuranceEnv(gym.Env):
    ...
    def __init__(self, num_agents, num_insurances):
        ...
        for i in range(self.NUM_INSURANCES):
            if i%2==0:
    ...
    def step(self, agent_actions):
        ...
        return [observation for _ in range(self.NUM_INSURANCES+self.NUM_AGENTS)], (*insurance_rewards, *agent_rewards), done, None
    ...
    def reset(self):
        ...
        self.action_counter = [0 for _ in range(self.NUM_INSURANCES*2+2)]
